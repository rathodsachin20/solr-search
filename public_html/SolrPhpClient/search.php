...
if ($query)
{
  ...
  $solr = new Apache_Solr_Service('54.187.160.88', 8983, '/solr/');
...
<?php
  ...
  foreach ($results->response->docs as $doc)
  {
          ...
          //echo "HIGHLIGHT of id ".$id."->".$highlight->Abstract[0]."--";
...
?>
          ...
          <tr>
            ...
            <td><?php echo htmlspecialchars($doc->Title, ENT_NOQUOTES, 'utf-8'); ?></td>
          </tr>
          <tr>
          ...
          <!--- <tr>
            <th><?php echo htmlspecialchars("Abstract", ENT_NOQUOTES, 'utf-8'); ?></th>
